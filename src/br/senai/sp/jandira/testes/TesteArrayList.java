...
//		}
		...
		for(Especialidade e : especialidades) {
			System.out.printf("%s --> %s\n", e.getNomeEspecialidade(), e.getDescricao());
		}
		
		System.out.println(e1.getCodigoEspecialiade());
		System.out.println(e2.getCodigoEspecialiade());
		System.out.println(e3.getCodigoEspecialiade());
